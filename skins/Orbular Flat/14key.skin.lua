...
noteskin:setColumns({
	offset = 0,
	align = "center",
	width = {54,54,54,54,54,54,54,54,54,54,54,54,54,54},
	space = {0, -27, -27, -27, -27, -27, -27, 0, -27, -27, -27, -27, -27, -27, 0},
})
...
playfield:addGuidelines({
    ...
    w = {4,4,4,4,4,4,4,1,4,4,4,4,4,4,4,4},
    h = {480,0,0,0,0,0,0,480,0,0,0,0,0,0,480},
    image = {},
	color = {1,1,1,.7},
    both = true,
    mode = "symmetric",
